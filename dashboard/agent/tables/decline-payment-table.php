...
function get_total_row($pdoConnect)
{
  ...
  $pdoResult->execute(array(":agent_id" =>$_SESSION['agent_session'], ":status" => "decline"));
...
$statement->execute(array(":agent_id" =>$_SESSION['agent_session'],":status" => "decline"));
...
$output = '
    ...
    <th>BOOKING DATE</th>
    <th>MESSAGE</th>
    <th>DECLINE RESERVATION DATE</th>
    </thead>
';
  while($row=$statement->fetch(PDO::FETCH_ASSOC))
  {
    ...
    if($row["status"] == "decline"){
      $status = '<button type="button" class="btn btn-warning N">Decline</button>';
    }
